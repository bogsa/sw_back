...
namespace sw.Datos.Migrations
{
    ...
    [Migration("20250320211516_200325-001")]
    partial class _200325001
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("sw.Entidades.Configuracion.Productos.E_Marca", b =>
                {
                    ...
                    b.ToTable("Pro_Marca", (string)null);
                });

            modelBuilder.Entity("sw.Entidades.Configuracion.Productos.E_Proveedor", b =>
                {
            ...
            modelBuilder.Entity("sw.Entidades.Productos.Producto.E_Producto", b =>
                {
                    ...
                    b.HasOne("sw.Entidades.Configuracion.Productos.E_Proveedor", "E_Proveedor")
                        .WithMany()
