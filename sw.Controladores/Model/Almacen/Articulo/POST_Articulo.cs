...
namespace sw.Controladores.Model.Almacen.Articulo
{
    public class POST_Articulo
    {
      /*---   DATOS GENERALES   ---------------------------------------------------------*/
        ...
        public List<POST_InventarioDetallePrecios> POST_InventarioDetallePrecios { get; set; }
        /*---   IMPUESTOS   ---------------------------------------------------------*/
        public int E_ObjetoImpuestoId { get; set; }
        public string CuentaPredial { get; set; } 
        public List<POST_ArticuloDetalleImpuestos> POST_ArticuloDetalleImpuestos { get; set; }
